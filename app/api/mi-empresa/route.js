...
export async function POST(request) {
  try {
    ...
    const {
      ...
      cump_fecha_pago_seguridad_social = null,
    ...
    const { rows } = await sql`
      INSERT INTO mi_empresa (
        ...
        cump_fecha_pago_seguridad_social, cump_aportes_al_dia,
      ...
      ON CONFLICT (id) DO UPDATE SET
        ...
        cump_fecha_pago_seguridad_social = EXCLUDED.cump_fecha_pago_seguridad_social,
